  ...
  <div>
    ...
    <div class="content-wrap">
      ...
      <div class="inputPicker">
        <span>发起时间:</span>
        <input type="text" readonly="" placeholder="请输入发起时间" @click='openPicker(2)' v-model='list.CreateDate' :disabled="disabled">
      </div>
      <div class="inputPicker">
        <span>截止时间:</span>
...
export default {
  ...
  methods: {
    init: function () {
      ...
      ajaxManuscriptsDetail(_this.keyValue, function (data) {
        _this.list = data
    ...
    modify: function () {
      ...
      if (_this.edit === '编辑') {
        ...
        ajaxManuscriptsEdit(_this.keyValue, _this.list, function (data) {
          console.log(data)
